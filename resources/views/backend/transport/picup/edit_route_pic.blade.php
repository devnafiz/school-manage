...
@section('title', __('Picup Route Edit'))
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="route_id">
                                            ...
                                            <option value="{{$route->id}}" {{($all_data->id==$route->id) ? "selected" : ""}}>{{$route->name}} </option>
                                            @endforeach
